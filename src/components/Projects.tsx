    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <SectionHeading
          ...
          subtitle="A showcase of applications I've built across different domains — from security platforms to full-stack products"
        />
            ...
            {filtered.map((project, i) => {
              ...
              return (
                <motion.div
                  ...
                  whileHover={{ y: -6 }}
                  className="group relative rounded-xl bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 overflow-hidden hover:border-primary/50 dark:hover:border-primary/50 transition-all hover:shadow-xl hover:shadow-primary/5 flex flex-col"
                >
                  {/* Project image placeholder */}
                  <div className="h-48 bg-gradient-to-br from-primary/20 via-accent/20 to-cyan/20 flex items-center justify-center relative overflow-hidden shrink-0">
                  ...
                  <div className="p-6 flex flex-col flex-1">
                    ...
                    <div className="flex items-center gap-4 pt-4 border-t border-slate-200 dark:border-slate-700 mt-auto">
                      ...
                      {hasDemo ? (
                        ...
                        <span className="flex items-center gap-2 text-sm text-slate-400 dark:text-slate-600 cursor-not-allowed">
                          <FiLock size={16} />
                          Demo Soon
                        </span>
                      )}
